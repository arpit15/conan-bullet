...
void b3RobotSimulatorClientAPI::setAdditionalSearchPath(char* path)
{
	b3SetAdditionalSearchPath(m_data->m_physicsClientHandle, path);
}
...
// 		}
		case eCONNECT_DIRECT:
		{
			...
			// reinterpret_cast<PhysicsDirect*>(sm)->m_data->m_verboseOutput = true;
			break;
		}
